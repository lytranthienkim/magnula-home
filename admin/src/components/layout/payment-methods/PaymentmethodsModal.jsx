'use client';
export default function PaymentMethodsModal({ selected, editMode, editData, saving, onClose, onEditModeChange, onEditDataChange, onSave, onRestore }) {
  if (!selected) return null;
  const display = editMode ? editData : selected;
  const isDeleted = selected.deletedAt !== null;
  const getFieldDisplay = (obj) => obj.name || obj.name || 'N/A';
