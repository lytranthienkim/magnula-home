...
import { getAllMaterials, createMaterial, updateMaterial, restoreMaterial } from '@/api/productAttributes';
import {
  MaterialsHeader,
  MaterialsTable,
  MaterialsModal,
} from '@/components/layout/materials';
...
export default function MaterialsPage() {
  ...
  const handleSave = async () => {
    ...
    try {
      await updateMaterial(selected.id, editData);
  ...
  const handleRestore = async () => {
    setStatusUpdating(true);
    try {
      await restoreMaterial(selected.id);
