                ...
                <div className="flex-1 bg-gray-50 px-4 py-2">
                  {editMode ? (
                    <input
                      ...
                      onChange={(e) => onEditDataChange({ ...editData, categoryName: e.target.value })}
                      className="w-full px-4 py-2 bg-white border border-gray-400 text-xs text-black focus:outline-none"
                    />
                  ) : (
                    <p className="text-xs font-medium text-black">{selectedCategory.categoryName}</p>
                  )}
                </div>
              </div>
              ...
              <div className="flex items-start">
                ...
                <div className="flex-1 bg-gray-50 px-4 py-2">
                  {editMode ? (
                    ...
                    <p className="text-xs text-black">{selectedCategory.description || 'N/A'}</p>
                  )}
                </div>
              </div>
              ...
              <div className="flex items-center">
                ...
                <div className="flex-1 bg-gray-50 px-4 py-2">
                  {editMode ? (
                    ...
                    <span className={`px-2 py-1 rounded text-xs font-semibold ${selectedCategory.isActive ? 'bg-green-100 text-green-700' : 'bg-gray-100 text-gray-700'}`}>
            ...
            <>
              <button
                onClick={() => {
                  ...
                  onEditDataChange(selectedCategory);
                }}
            ...
            <>
              {isDeleted ? (
                ...
                <>
                  ...
                  <button
                    onClick={() => { onEditDataChange(selectedCategory); onEditModeChange(true); }}
