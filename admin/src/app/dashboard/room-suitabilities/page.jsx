...
import { getAllRoomSuitabilities, createRoomSuitability, updateRoomSuitability, restoreRoomSuitability } from '@/api/productAttributes';
import {
  RoomSuitabilitiesHeader,
  RoomSuitabilitiesTable,
  RoomSuitabilitiesModal,
} from '@/components/layout/room-suitabilities';
...
export default function RoomSuitabilitiesPage() {
  ...
  const handleSave = async () => {
    ...
    try {
      await updateRoomSuitability(selected.id, editData);
  ...
  const handleRestore = async () => {
    setStatusUpdating(true);
    try {
      await restoreRoomSuitability(selected.id);
